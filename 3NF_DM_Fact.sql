...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_transactions(p_full_reload boolean DEFAULT false)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_fct_sales_daily_dm(p_months_back int DEFAULT 3)
LANGUAGE plpgsql
AS $$
DECLARE

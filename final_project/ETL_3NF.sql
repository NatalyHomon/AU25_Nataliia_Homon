...
BEGIN
    ...
    -- 1) 100% uppercase and long (>10)
    IF v = upper(v) AND v_len > 10 THEN
        RETURN false;
    END IF;

    -- 2) Suspicious marketing keywords (3+ occurrences)
    IF (
        length(regexp_replace(upper(v),
            '(CLICK|BONUS|WIN|FREE|SALE|NOW)', '', 'g')
        ) < v_len - 10
    ) THEN
        RETURN false;
    END IF;

    -- 3) Too many repeated words
    SELECT count(*) INTO v_word_count
    FROM (
        SELECT word
        FROM regexp_split_to_table(lower(v), '\s+') word
        GROUP BY word
        HAVING count(*) > 2
    ) t;
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_brands(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_unit_of_measures(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_suppliers(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_product_departments(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_product_subcategories(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
AS $$
    ...
    SELECT DISTINCT ON (product_sku_src_id, source_system, source_entity)
        product_sku_src_id,
        product_name,
        ...
        source_entity,
        source_id,
        load_dts AS max_load_dts
    FROM enriched
    ORDER BY
        product_sku_src_id, source_system, source_entity,
        load_dts DESC;
$$;

CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_products(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_promotions(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_regions_via_map(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_cities_via_map(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_store_formats(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
SELECT DISTINCT ON (store_src_id, source_system, source_entity)
    ...
    source_entity::varchar(60),
    source_id::varchar(100),
    load_dts::timestamptz AS max_load_dts
FROM map
ORDER BY
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_stores(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_delivery_addresses(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_fulfillment_centers(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_delivery_types(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_delivery_providers(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_sales_channels(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_payment_methods(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_payment_gateways(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_order_statuses(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_receipt_types(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_card_types(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_device_types(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_terminal_types(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_terminals(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_shifts(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE PROCEDURE bl_cl.pr_load_ce_employees(p_full_reload boolean DEFAULT FALSE, p_run_id uuid DEFAULT NULL)
LANGUAGE plpgsql
AS $$
DECLARE

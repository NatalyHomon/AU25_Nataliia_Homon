CREATE TABLE IF NOT EXISTS DIM_DATES_DAY (
    ...
    WEEL_OF_YEAR   SMALLINT    NOT NULL,  
    ...
    CONSTRAINT CHK_DIM_DATES_WOY        CHECK (WEEL_OF_YEAR BETWEEN 1 AND 53),
...
INSERT INTO DIM_DATES_DAY (
    ...
    WEEK, WEEL_OF_YEAR, MONTH, MONTH_NAME,
...
FROM (
    SELECT
        ...
        EXTRACT(WEEK FROM d)::SMALLINT        AS WEEL_OF_YEAR,
